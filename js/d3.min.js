...
(function(t, n) {
    ...
    function P(t, n, e, r, i, o) {
        for (var u, a = 0, c = n.length, s = o.length; a < s; ++a)
            (u = n[a]) ? (u.__data__ = o[a], r[a] = u) : e[a] = new z(t, o[a]);
        for (; a < c; ++a)
            (u = n[a]) && (i[a] = u)
    }
    function L(t, n, e, r, i, o, u) {
        var a,
            ...
            p = new Array(l);
        for (a = 0; a < l; ++a)
            (c = n[a]) && (p[a] = s = Wf + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
        for (a = 0; a < h; ++a)
            s = Wf + u.call(t, o[a], a, o), (c = f[s]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new z(t, o[a]);
        for (a = 0; a < l; ++a)
            (c = n[a]) && f[p[a]] === c && (i[a] = c)
    }
    function R(t, n) {
        ...
        function u() {
            ...
            function u() {
                if (we(), t.event.touches) {
                    ...
                    gt(t.event.view, b), B.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
    ...
    function oi(t, n, e, r, i, o) {
        if (e) {
            ...
            for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
                s = Nr([u, -a * T_(f), -a * A_(f)]), t.point(s[0], s[1])
        }
    }
    function ui(t, n) {
        n = Er(n), n[0] -= t, Lr(n);
    ...
    function si(t, n, e, r) {
        ...
        return function(u) {
            ...
            function d(o, u) {
                var a = i(o, u);
                if (_ && g.push([o, u]), T)
                    y = o, m = u, x = a, T = !1, a && (S.lineStart(), S.point(o, u));
                else if (a && M)
                    S.point(o, u);
                else {
    ...
    function $i(t, n, e, r) {
        var i;
        if (null == t)
            i = e * __, r.point(-v_, i), r.point(0, i), r.point(v_, i), r.point(v_, 0), r.point(v_, -i), r.point(0, -i), r.point(-v_, -i), r.point(-v_, 0), r.point(-v_, i);
        ...
        for (null == n && (n = zo); e = s.pop();)
            if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length))
                for (e.children = new Array(u), o = u - 1; o >= 0; --o)
                    s.push(r = e.children[o] = new Ro(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function Do(t, n) {
        ...
        for (; u;)
            i = u._, r = u.next, e && Uo(e, i) ? o = u : (o ? (t.tail = o, o.next = null) : t.head = t.tail = null, n.push(i), e = Do(t, n), n.pop(), t.head ? (u.next = t.head, t.head = u) : (u.next = null, t.head = t.tail = u), o = t.tail, o.next = r), u = r;
        return t.tail = o, e
    }
    function Oo(t) {
        return {
    ...
    function Xo(t) {
        ...
        for (a = 3; a < i; ++a) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, v += d = r._.r * r._.r, _ += d * r._.x, g += d * r._.y, h = jo(n, o = _ / v, u = g / v); (r = r.next) !== e;)
        ...
        for (var n, e, r, i, o, u = new au(t, 0), a = [u]; n = a.pop();)
            if (r = n._.children)
                for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i)
                    a.push(e = n.children[i] = new au(r[i], i)), e.parent = n;
        ...
        function n(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++a < s;)
                    37 === t.charCodeAt(a) && (u.push(t.slice(c, a)), null != (i = qx[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), u.push(r), c = a + 1);
        ...
        function r(t, n, e, r) {
            for (var i, o, u = 0, a = n.length, c = e.length; u < a;) {
                ...
                if (37 === (i = n.charCodeAt(u++))) {
                    if (i = n.charAt(u++), !(o = B[i in qx ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
                        return -1
        ...
        for (i = 0; i < _; ++i)
            if (o = kw[i]) {
                ...
                for (a = 0, s = c.length; a < s;)
                    p = fs(o, Nw[c[a]]), d = p[0], v = p[1], f = ss(o, Nw[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > Cw || Math.abs(v - h) > Cw) && (c.splice(a, 0, Nw.push(es(u, p, Math.abs(d - t) < Cw && r - v > Cw ? [t, Math.abs(l - t) < Cw ? h : r] : Math.abs(v - r) < Cw && e - d > Cw ? [Math.abs(h - r) < Cw ? l : e, r] : Math.abs(d - e) < Cw && v - n > Cw ? [e, Math.abs(l - e) < Cw ? h : n] : Math.abs(v - n) < Cw && d - t > Cw ? [Math.abs(h - n) < Cw ? l : t, n] : null)) - 1), ++s);
                s && (g = !1)
            }
        if (g) {
            var y,
            ...
            for (i = 0, g = null; i < _; ++i)
                (o = kw[i]) && (u = o.site, y = u[0] - t, m = u[1] - n, (x = y * y + m * m) < b && (b = x, g = o));
            if (g) {
                var w = [t, n],
                    M = [t, r],
                    T = [e, r],
    ...
    function ms(t) {
        var n = t.circle,
            ...
            a = [t];
        ys(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < Cw && Math.abs(r - c.circle.cy) < Cw;)
            o = c.P, a.unshift(c), ys(c), c = o;
        a.unshift(c), vs(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < Cw && Math.abs(r - s.circle.cy) < Cw;)
            u = s.N, a.push(s), ys(s), s = u;
        a.push(s), vs(s);
        var f,
            l = a.length;
        for (f = 1; f < l; ++f)
            s = a[f], c = a[f - 1], rs(s.edge, c.site, s.site, i);
    ...
    function xs(t) {
        ...
        if (Tw.insert(n, c), n || e) {
            if (n === e)
                return vs(n), e = gs(n.site), Tw.insert(c, e), c.edge = e.edge = ns(n.site, c.site), ds(n), void ds(e);
            if (!e)
    ...
    function ks(t, n) {
        ...
        for (Nw = [], kw = new Array(t.length), Tw = new Gc, Sw = new Gc;;)
            if (i = Mw, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))
                o[0] === e && o[1] === r || (xs(o), e = o[0], r = o[1]), o = t.pop();
            else {
                if (!i)
                    break;
                ms(i.arc)
    ...
    var Ls = function(t, n) {
        ...
        ef = function() {
            function t(t) {
                ...
                for (i = 0; i < u; ++i)
                    o = a[i], s <= o && o <= f && d[Us(l, o, 0, h)].push(t[i]);
                return d
            }
            var n = Zs,
                e = Hs,
        ...
        cf = function(t, n) {
            ...
            if (null == n)
                for (; ++o < i;)
                    isNaN(e = Ys(t[o])) ? --u : r += e;
            else
                for (; ++o < i;)
                    isNaN(e = Ys(n(t[o], o, t))) ? --u : r += e;
            if (u)
                return r / u
        },
        sf = function(t, n) {
    ...
    var Uf = function(t, n, e) {
            ...
            {
                if (!(arguments.length < 2)) {
                    for (a = n ? N : S, null == e && (e = !1), r = 0; r < u; ++r)
                        this.each(a(o[r], n, e));
                    return this
                }
    ...
    var oh,
        ...
        Ph = function(t, n) {
            var e,
                ...
                h = f * f + l * l;
            if (h < 1e-12)
                r = Math.log(s / u) / zh, e = function(t) {
    ...
    var Zh = function(t, n, e) {
        ...
        ap = function(t, n) {
            ...
            if (o) {
                n = null == n ? null : n + "";
                for (i in o)
                    (e = o[i]).name === n ? (r = e.state > np && e.state < ip, e.state = op, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
        ...
        bp = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
                for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
                    if (c = s[l]) {
                        for (var h, p = t.call(c, c.__data__, l, s), d = kn(c, e), v = 0, _ = p.length; v < _; ++v)
    ...
    var Cd = function() {
        function t() {
            var t,
                ...
                _ = i.apply(this, a) - bd,
                g = o.apply(this, a) - bd;
            if (u || (u = t = Re()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === g || (u.quadraticCurveTo(0, 0, v * yd(_), v * md(_)), u.arc(0, 0, v, _, g)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t)
    ...
    var zd = function() {
            function t(n, i, u, a) {
                ...
                for (var c, s, f, l = -1, h = n.length, p = o[i++], d = Ye(), v = u(); ++l < h;)
            ...
            function e(n) {
                for (var e = 0, r = t.length; e < d; ++e)
                    for (var i, o, c, s, l, h, p, v = 0; v < r; ++v)
                        i = t[v], o = i.source, c = i.target, s = c.x + c.vx - o.x - o.vx || Zd(), l = c.y + c.vy - o.y - o.vy || Zd(), h = Math.sqrt(s * s + l * l), h = (h - a[v]) / h * n * u[v], s *= h, l *= h, c.vx -= s * (p = f[v]), c.vy -= l * p, o.vx += s * (p = 1 - p), o.vy += l * p
            }
            function r() {
                if (c) {
                    var n,
                    ...
                    for (n = 0, s = new Array(r); n < h; ++n)
                        e = t[n], e.index = n, "object" != typeof e.source && (e.source = cr(p, e.source)), "object" != typeof e.target && (e.target = cr(p, e.target)), s[e.source.index] = (s[e.source.index] || 0) + 1, s[e.target.index] = (s[e.target.index] || 0) + 1;
        ...
        _v = function() {
            ...
            function r(t, n, e, r) {
                ...
                var i = t.x - o.x,
                    ...
                    p = i * i + c * c;
                if (h * h / l < p)
                    return p < f && (0 === i && (i = Zd(), p += i * i), 0 === c && (c = Zd(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p), !0;
                if (!(t.length || p >= f)) {
        ...
        B_ = function(t) {
            ...
            if (Hv = jv = -(Yv = Bv = 1 / 0), Zv = [], q_(t, Y_), e = Zv.length) {
                for (Zv.sort(Br), n = 1, r = Zv[0], o = [r]; n < e; ++n)
                    i = Zv[n], jr(r, i[0]) || jr(r, i[1]) ? (Yr(r[0], i[1]) > Yr(r[0], r[1]) && (r[1] = i[1]), Yr(i[0], r[1]) > Yr(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
                for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n)
                    i = o[n], (a = Yr(r[1], i[0])) > u && (u = a, Yv = i[0], jv = r[1])
            }
                ...
                function h() {
                    ...
                    if (v.pop(), p.push(v), v = null, a)
                        if (1 & i) {
                            ...
                            a > 1 && 2 & i && u.push(u.pop().concat(u.shift())), d.push(u.filter(ji))
                }
                var p,
                    d,
                    v,
            ...
            function i(t) {
                ...
                return {
                    ...
                    point: function(l, h) {
                        ...
                        if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (cg(n, p) || cg(d, p)) && (d[0] += d_, d[1] += d_, v = r(d[0], d[1]))), v !== i)
        ...
        Xy = function() {
            function t(t) {
                var r,
                    ...
                    h = {};
                for (i = 0; i < f; ++i)
                    r = t[i], a = l[i] = new Ro(r), null != (c = n(r, i, t)) && (c += "") && (s = By + (a.id = c), h[s] = s in h ? Hy : a);
                for (i = 0; i < f; ++i)
                ...
                }).eachBefore(Lo), o.parent = null, f > 0)
            ...
            function r(t, n, e) {
                if (n) {
                    for (var r, i = t, u = t, a = n, c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m; a = ru(a), i = eu(i), a && i;)
                        c = eu(c), u = ru(u), u.a = t, r = a.z + l - i.z - s + o(a._, i._), r > 0 && (iu(uu(a, t, e), t, r), s += r, f += r), l += a.m, s += i.m, h += c.m, f += u.m;
        ...
        Ky = function t(n) {
            function e(t, e, r, i, o) {
                if ((u = t._squarify) && u.ratio === n)
                    ...
                    t._squarify = u = su(n, t, e, r, i, o), u.ratio = n
            }
            return e.ratio = function(n) {
                return t((n = +n) > 1 ? n : 1)
            }, e
        ...
        wb = function() {
            function t() {
                ...
                if (c || (c = t = Re()), l < f && (s = l, l = f, f = s), l > yb)
                    if (d > bb - yb)
                        c.moveTo(l * pb(h), l * _b(h)), c.arc(0, 0, l, h, p, !v), f > yb && (c.moveTo(f * pb(p), f * _b(p)), c.arc(0, 0, f, p, h, v));
                    else {
                        var _,
                            g,
                            y = h,
    ...
    Gc.prototype = {
        ...
        insert: function(t, n) {
            ...
            if (t) {
                ...
                this._ ? (t = ts(this._), n.P = null, n.N = t, t.P = t.L = n, e = t) : (n.P = n.N = null, this._ = n, e = null);
            for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;)
                r = e.U, e === r.L ? (i = r.R, i && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Qc(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Kc(this, r))) : (i = r.L, i && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (Kc(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Qc(this, r))), e = t.U;
            this._.C = !1
        },
        remove: function(t) {
            ...
            return this.cells.forEach(function(e, r) {
                if (o = (i = e.halfedges).length)
                    for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o;)
                        u = f, s = n[i[c]], f = s.left === a ? s.right : s.left, u && f && r < u.index && r < f.index && Ms(a, u, f) < 0 && t.push([a.data, u.data, f.data])
            }), t
        },
        links: function() {
        ...
        Uw = function() {
            ...
            function h() {
                if (y.apply(this, arguments)) {
                    var n,
                        ...
                        c = u.length;
                    for (As(), e = 0; e < c; ++e)
                        r = u[e], i = Ml(this, u, r.identifier), i = [i, this.__zoom.invert(i), r.identifier], o.touch0 ? o.touch1 || (o.touch1 = i) : (o.touch0 = i, n = !0);
                    if (_ && (_ = clearTimeout(_), !o.touch1))
                        return o.end(), void ((i = bl(this).on("dblclick.zoom")) && i.apply(this, arguments));
            ...
            function p() {
                ...
                for (qw(), _ && (_ = clearTimeout(_)), n = 0; n < l; ++n)
                    o = f[n], u = Ml(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
